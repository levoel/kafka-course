...
<CrossCourseRef
  ...
  lessonSlug="09-file-io-formats/05-compression-formats"
  label="Compression: gzip, zstd, snappy, lz4"
  preview="Как устроены алгоритмы сжатия в Python (gzip/lzma/zstandard) — параллель к compression.type=zstd в Kafka producer."
/>
