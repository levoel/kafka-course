...
<CrossCourseRef
  ...
  lessonSlug="11-logging-monitoring/02-structured-logging"
  label="Structured logging в Python"
  preview="Как Python-сервис логирует JSON-события — это естественный источник для Kafka producer'а в pipeline'е structured logs → Kafka → ClickHouse/Flink."
/>
