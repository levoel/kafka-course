...
<CrossCourseRef
  ...
  lessonSlug="11-ingestion-patterns/06-materialized-postgresql-mysql"
  label="ClickHouse: MaterializedPostgreSQL/MySQL"
  preview="Альтернативный CDC-путь без Kafka — встроенный в ClickHouse engine читает Postgres logical replication / MySQL binlog. Сравните с Kafka Connect Sink для Postgres."
/>

<CrossCourseRef
  courseId="clickhouse-course"
  lessonSlug="11-ingestion-patterns/11-clickpipes"
  label="ClickPipes: managed CDC в ClickHouse Cloud"
  preview="ClickPipes Postgres CDC GA (PeerDB) — managed-альтернатива самописному Kafka Connect → ClickHouse pipeline'у."
/>
