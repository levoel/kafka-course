...
<CrossCourseRef courseId="debezium" lessonSlug="05-module-5/07-schema-registry-avro" title="Schema Registry и Avro в CDC-контексте" />

<CrossCourseRef
  courseId="storage-formats"
  lessonSlug="04-avro/02-schema-type-system"
  label="Avro: type system на уровне формата"
  preview="Primitive и complex типы Avro, default values, union semantics — фундамент, на котором стоит Confluent Schema Registry."
/>
