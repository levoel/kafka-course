...
<CrossCourseRef
  ...
  lessonSlug="04-stream-processing/01-kafka-architecture"
  label="System Design: Kafka в архитектуре data-platform"
  preview="Как Kafka вписывается в общий стрим-стек на уровне system design — рядом с Flink, Iceberg и downstream-сервисами."
/>

<CrossCourseRef
  courseId="sd-data-engineer"
  lessonSlug="02-pipeline-patterns/02-lambda-kappa-medallion"
  label="Lambda/Kappa/Medallion patterns"
  preview="Где Event Sourcing-логика встаёт в Kappa-архитектуру и как медальонная схема (bronze → silver → gold) сочетается с replayable event log."
/>
