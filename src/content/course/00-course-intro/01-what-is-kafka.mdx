...
<CrossCourseRef
  ...
  label="System Design: Kafka в стрим-архитектуре"
  preview="Где Kafka стоит в общей архитектуре real-time data-platform — рядом с Flink, ClickHouse, Iceberg и downstream-потребителями."
/>
