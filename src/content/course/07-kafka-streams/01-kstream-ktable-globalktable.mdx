...
<CrossCourseRef
  ...
  lessonSlug="09-structured-streaming/01-streaming-fundamentals"
  label="Spark Structured Streaming: основы"
  preview="Альтернативный stream-processing движок поверх того же Kafka source — micro-batch модель vs Kafka Streams record-at-a-time. Полезно сравнить trade-offs."
/>

<CrossCourseRef
  courseId="spark-course"
  lessonSlug="09-structured-streaming/06b-transform-with-state"
  label="Spark transformWithState: stateful processing"
  preview="Spark 4.0 Arbitrary State API v2 — параллель с Kafka Streams Processor API. Сравнение моделей state store, TTL и timers."
/>
